    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/post')) {
            ...
            if ($pathinfo === '/post/') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\PostController::createAction',  '_route' => 'post_create',);
            }
            not_post_create:
            ...
            if ($pathinfo === '/post/new') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\PostController::newAction',  '_route' => 'post_new',);
            }
            not_post_new:
            ...
            if (preg_match('#^/post/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'post_update')), array (  '_controller' => 'AppBundle\\Controller\\PostController::updateAction',));
            }
            not_post_update:
            ...
            if (preg_match('#^/post/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'delete')), array (  '_controller' => 'AppBundle\\Controller\\PostController::deleteAction2',));
            }
            not_delete:
